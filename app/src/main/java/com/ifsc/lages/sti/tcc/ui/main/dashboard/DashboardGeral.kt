...
class DashboardGeral(private val mContext: Context, private val mViewRoot: View) : MapElement {
    ...
    override fun mapComponents() {
        imageView = mViewRoot.findViewById(R.id.img_max)
        expadablePichart = mViewRoot.findViewById(R.id.container_expadable_pichart)
        createChart()
    }
    override fun mapActionComponents() {
        imageView?.setOnClickListener(object : View.OnClickListener {
            override fun onClick(p0: View?) {
                expadablePichart?.toggle()
            }
        })
    }
