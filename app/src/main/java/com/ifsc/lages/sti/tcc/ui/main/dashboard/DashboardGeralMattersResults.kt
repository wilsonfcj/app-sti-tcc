...
import com.ifsc.lages.sti.tcc.ui.main.dashboard.adapter.ViewPagerLastMatterAdapter
import com.ifsc.lages.sti.tcc.utilidades.components.CustomLayoutMsm
import java.lang.IndexOutOfBoundsException


class DashboardGeralMattersResults(private val mContext: AppCompatActivity, private val mViewRoot: View) : MapElement{

    private var pagerIndicator: LinearLayout? = null
    private var previous_pos = 0
    private var dotsCount = 0
    private  var dots : Array<ImageView?> = emptyArray()
    private var resultOverall : MutableList<ResultMatters>? = null
    private var recyclerView : ViewPager? = null
    private var adapter : ViewPagerLastMatterAdapter? = null
...
//        btnPlusInfo = mViewRoot.findViewById(R.id.btn_plus_info_last) as Button
        recyclerView = mViewRoot.findViewById(R.id.pager_introduction_matters) as ViewPager
        pagerIndicator = mViewRoot.findViewById(R.id.view_pager_count_dots_matters) as LinearLayout
        progressLast = mViewRoot.findViewById(R.id.progress_matters) as ProgressBar
        layoutError  = mViewRoot.findViewById(R.id.layout_error_matters)
    }
...
//        }
    ...
    fun showDashboard(resultado : MutableList<ResultMatters>) {
