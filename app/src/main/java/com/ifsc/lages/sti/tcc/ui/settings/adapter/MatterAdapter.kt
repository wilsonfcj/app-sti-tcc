...
class MatterAdapter (
    private val infos: MutableList<Matter>?,
    var context: Context) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val lView = LayoutInflater.from(parent.context)
            .inflate(R.layout.list_item_matters_settings, parent, false)
    ...
    inner class ViewHolder(aView : View) : RecyclerView.ViewHolder(aView) {
        val txtDescricao : TextView = aView.findViewById(R.id.txt_description)
    }
}